...
final class PictureBridgeClientEvents {
    ...
    public void onMouseInput(GuiScreenEvent.MouseInputEvent.Pre event) {
        if (!(event.getGui() instanceof GuiChat) || Mouse.getEventButton() != 0 || !Mouse.getEventButtonState()) {
            return;
        }
        ...
        ITextComponent component = minecraft.ingameGUI.getChatGUI().getChatComponent(mouseX, mouseY);
