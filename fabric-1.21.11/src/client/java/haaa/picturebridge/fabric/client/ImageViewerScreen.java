...
public final class ImageViewerScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        // frame, which Minecraft 1.21.11 rejects with "Can only blur once per frame".
        ...
        context.drawStrokedRectangle(
                area.left, area.top, area.width(), area.height(), 0xFF3A3D46);
    ...
    private void renderError(DrawContext context, ImageArea area) {
        ...
        context.drawWrappedTextWithShadow(textRenderer, errorText, startX, startY + 18, contentWidth, 0xD5D9E2);
    }
    ...
    public boolean mouseScrolled(double mouseX,
        ...
        zoom = MathHelper.clamp(zoom * Math.pow(1.2, verticalAmount), MIN_ZOOM, MAX_ZOOM);
